...
namespace SampleBinaryClassification.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\code\cli-test\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 5E-07f, ConvergenceTolerance = 0.01f, NumberOfIterations = 5, Shuffle = true, LabelColumnName = "Label", FeatureColumnName = "Features" });
